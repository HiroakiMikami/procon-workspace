/*
URL https://beta.atcoder.jp/contests/abc059/tasks/abc059_a
SCORE 100
AC true
WA false
TLE false
...
void body() {
    ...
    auto c1 = static_cast<char>(toupper(s1.front()));
    auto c2 = static_cast<char>(toupper(s2.front()));
    auto c3 = static_cast<char>(toupper(s3.front()));
