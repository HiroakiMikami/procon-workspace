...
void body() {
     ...
     * 分針と秒針の差Xは6M+S/10-6S=6M-59/10S[degree]、これが(360-1/10) [degree/sec]で縮まるから、
     * 10*(6M-59S/10)/(3599)=(60M-59S)/3599 秒後に最初に重なる。
     * これが負の時は、360/(3599/10)=3600/3599を足す
     *
     ...
     *
     * ii) C1 > 0
     * [(60M-59S)/3599)+3600/3599*(C1-1):(60M+S)/3599)+3600/3599*C1)
     */
    i64 min_1, max_1;
    auto X = 60*M - 50*S;
    if (X < 0) {
