/*
URL https://beta.atcoder.jp/contests/arc094/tasks/arc094_c
SCORE 700
AC true
WA true
TLE false
...
それに気づいたあと、ナップザック問題が必要と考えて躓いた。

操作を考えるより、最終的にどうあるかを考えたほうがよいのかも？
*/
#include <iostream>
#include <cstdint>
#include <utility>
