/*
URL https://beta.atcoder.jp/contests/arc061/tasks/arc061_a
SCORE 300
AC true
WA false
TLE false
MLE false
TASK_TYPE 場合の数 全探索
FAILURE_TYPE オーバーフロー 実装力不足
NOTES
・atoiでオーバーフローしたので、string2numberを何かutil化しておいたほうが良さそう
・パターンの列挙の方法をutil化したい（bit使っているやつ）
・ついでにnext_permutationあたりも使えるようになりたい
*/
#include <iostream>
#include <cstdint>
#include <utility>
