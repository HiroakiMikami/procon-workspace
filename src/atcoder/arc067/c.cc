/*
URL https://beta.atcoder.jp/contests/arc067/tasks/arc067_a
SCORE 300
AC true
WA false
TLE false
MLE false
TASK_TYPE 素因数分解 数学 数え上げ
FAILURE_TYPE 計算量見積もり
NOTES
素因数分解の計算量などをぱっと思い出せなかった。どこかに書いておきたい。
数学utilの各関数が何をするものだったか思い出すのにかkる時間が無駄。要コメント
*/
#include <iostream>
#include <cstdint>
#include <utility>
