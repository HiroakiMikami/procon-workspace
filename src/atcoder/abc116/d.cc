...
void body() {
     ...
     */
    OrderedMap<i64, i64> occurrence;

    // Sort by d_i
    sort(CTR(tds), [](auto x1, auto x2) { return x1.second > x2.second; });

    /*
     * First: select K sushi by using only d_i
     */
    i64 point = 0;
    i64 x = 0;
    REP (i, K) {
