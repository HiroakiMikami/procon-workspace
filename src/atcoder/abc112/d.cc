/*
URL https://beta.atcoder.jp/contests/abc112/tasks/abc112_d
SCORE 400
AC true
WA false
TLE false
MLE false
TASK_TYPE 数列 約数 列挙 全探索
FAILURE_TYPE
NOTES
*/
#include <iostream>
...
void body() {
    ...
    /*
     * sum a_i = Mかつgcd(a_i)=kとすると、
     * a_i = k * b_iとして、k * sum b_i = Mかつgcd(b_i)=1
     * a_i > 0より、b_i > 0だから、sum b_i >= N
