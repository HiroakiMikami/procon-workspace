/*
URL https://beta.atcoder.jp/contests/code-thanks-festival-2017-open/tasks/code_thanks_festival_2017_c
SCORE 300
AC true
WA false
TLE false
MLE false
TASK_TYPE PriorityQueue 最大化・最小化 シミュレーション
FAILURE_TYPE
NOTES
*/
#include <iostream>
...
template <typename V, typename F = std::less<V>>
using PriorityQueue = std::priority_queue<V, Vector<V>, F>;
