/*
URL https://beta.atcoder.jp/contests/arc066/tasks/arc066_c
SCORE 900
AC true
WA false
TLE false
MLE false
TASK_TYPE DP 最小化・最大化 整数
FAILURE_TYPE 考察力不足
NOTES
DPなのはすぐにわかったが、後ろから決めていくDPにこだわって愚直解の構成ができなかった。
その後、m<=2にできないかとは思ったが、自分の考察ではできないと思ってしまった。
*/
#include <iostream>
#include <cstdint>
#include <utility>
...
void body() {
    ...
    /*
     * dp[n][m] = 前からn番目まで、m個括弧が開いている条件での最大値
     *
     * m >= 3は考えなくてよい。
