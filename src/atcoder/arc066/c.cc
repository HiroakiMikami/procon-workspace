/*
URL https://beta.atcoder.jp/contests/arc066/tasks/arc066_a
SCORE 300
AC true
WA false
TLE false
MLE false
TASK_TYPE 判定 場合の数 mod 数え上げ
FAILURE_TYPE 条件分岐否定忘れ
NOTES
*/
#include <iostream>
#include <cstdint>
...
void body() {
    ...
    cout << pow(mod::Integer(2), i64(N / 2)).get() << endl;
}
