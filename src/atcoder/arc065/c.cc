/*
URL https://beta.atcoder.jp/contests/arc065/tasks/arc065_a
SCORE 300
AC true
WA false
TLE false
MLE false
TASK_TYPE 文字列 前方一致
FAILURE_TYPE 考察不足 util不足
NOTES
考察が曖昧のまま進めた結果、ときながら考察して苦戦した気がする
文字列系のutilはあったほうが良いかも
・starts_with
・ends_with
・etc
*/
...
void body() {
    ...
    Vector<string> W = { "dreamer", "eraser", "dream", "erase" };
    EACH(w, W) {
        reverse(CTR(w));
    }
