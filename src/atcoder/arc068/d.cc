/*
URL https://beta.atcoder.jp/contests/arc068/tasks/arc068_b
SCORE 400
AC true
WA false
TLE false
MLE false
TASK_TYPE シミュレーション 最大化・最小化
FAILURE_TYPE
NOTES
重複している数字2つを消していく作業をすれば良いので、何個食べることになるか計算できる
ただし、1回の操作で2枚食べるので、消さないといけない数字が奇数個の場合に注意
*/
#include <iostream>
#include <cstdint>
#include <utility>
